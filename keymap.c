...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
      ...
      KC_LCTL,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,                         KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH, KC_QUOT,
                                          KC_LALT,   MO(1),  KC_SPC,    KC_BSPC,   MO(2), KC_ESC
    ),

    // Layer 1: Numbers & Symbols (Colemak)
    [1] = LAYOUT_split_3x6_3(
       KC_TAB, KC_EXLM,   KC_AT, KC_LPRN, KC_RPRN, KC_PIPE,                      KC_QUOT,    KC_7,    KC_8,    KC_9, KC_ASTR,  KC_GRV,
      KC_LSFT, KC_HASH,  KC_DLR, KC_LCBR, KC_RCBR,  KC_GRV,                      XXXXXXX,    KC_4,    KC_5,    KC_6,  KC_EQL, KC_MINS,
    ...
    [2] = LAYOUT_split_3x6_3(
      ...
      KC_LCTL, XXXXXXX,   KC_F9,  KC_F10,  KC_F11,  KC_F12,                      KC_HOME,   KC_F1,   KC_F2,   KC_F3,   KC_F4, KC_PGDN,
                                          KC_LALT,   MO(3),  KC_SPC,    KC_BSPC, _______, KC_ESC
    ),
